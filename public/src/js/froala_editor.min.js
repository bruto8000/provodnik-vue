...
! function(e, t) {
    ...
    V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function(i) {
        ...
        function i(e) {
            return !!e && (!!h.node.isBlock(e) || (e.nextSibling && e.nextSibling.nodeType === Node.TEXT_NODE && 0 === e.nextSibling.textContent.replace(/\u200b/g, "").length ? i(e.nextSibling) : !(e.nextSibling && (!e.previousSibling || "BR" !== e.nextSibling.tagName || e.nextSibling.nextSibling)) && i(e.parentNode)))
        }

        function a(e) {
            return !!e && (!!h.node.isBlock(e) || (e.previousSibling && e.previousSibling.nodeType === Node.TEXT_NODE && 0 === e.previousSibling.textContent.replace(/\u200b/g, "").length ? a(e.previousSibling) : !e.previousSibling && (!(e.previousSibling || !h.node.hasClass(e.parentNode, "fr-inner")) || a(e.parentNode))))
        }
        ...
        function n(e) {
            ...
            if ("BR" === (n = n.nextSibling).tagName && h.node.isEditable(n))
                ...
                else h.node.deepestParent(n) && ((!h.node.isEmpty(h.node.blockParent(n)) || (h.node.blockParent(n).nextSibling && V.NO_DELETE_TAGS.indexOf(h.node.blockParent(n).nextSibling.tagName)) < 0) && g(n).remove(), s(e));
                return
            }
        ...
        function l(e, t, n) {
            ...
            if (o && "BLOCKQUOTE" === o.tagName) return m(e, o) ? (r = h.html.defaultTag(), t ? g(e).replaceWith("<br>" + V.MARKERS) : r ? g(o).after("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : g(o).after("".concat(V.MARKERS, "<br>")), g(e).remove()) : b(e, t, n), !1;
        ...
        return {
            enter: function f(e) {
                ...
                h.el.normalize();
                var r = !1;
                0 < g(t).parentsUntil(h.$el, "BLOCKQUOTE").length && (r = !0), g(t).parentsUntil(h.$el, "TD, TH").length && (r = !1), i(t) ? !c(t) || e || r ? l(t, e, r) : h.cursorLists._endEnter(t) : a(t) ? !c(t) || e || r ? function s(e, t, n) {
                        var r, o = h.node.deepestParent(e, [], !n);
                        if (o && "TABLE" === o.tagName) return g(o).find("td, th").first().prepend(e), s(e, t, n);
                    ...
                    }(t, e, r) : h.cursorLists._startEnter(t) : !c(t) || e || r ? b(t, e, r) : h.cursorLists._middleEnter(t),
                    function o() {
                    ...
                    }(), h.html.fillEmptyBlocks(!0), h.opts.htmlUntouched || (h.html.cleanEmptyTags(), h.clean.lists(), h.spaces.normalizeAroundCursor()), h.selection.restore(), h.$oel[0].offsetHeight > h.o_win.innerHeight && h.o_win.scroll(0, h.$oel[0].scrollHeight)
            },
            backspace: function p() {
                ...
                return i(t) ? c(t) && u(t, g(t).parents("li").first().get(0)) ? h.cursorLists._backspace(t) : e = v(t) : a(t) ? c(t) && u(t, g(t).parents("li").first().get(0)) ? h.cursorLists._backspace(t) : function l(e) {
                ...
                }(t) : e = v(t), g(t).remove(), d(), h.html.fillEmptyBlocks(!0), h.opts.htmlUntouched || (h.html.cleanEmptyTags(), h.clean.lists(), h.spaces.normalizeAroundCursor()), h.selection.restore(), e
            },
            del: function r() {
                ...
                g(e).remove(), d(), h.html.fillEmptyBlocks(!0), h.opts.htmlUntouched || (h.html.cleanEmptyTags(), h.clean.lists()), h.spaces.normalizeAroundCursor(), h.selection.restore()
            },
            isAtEnd: m,
            isAtStart: u
        }
...
// import  './froala_editor.min.js'
// import  './froala/align.min.js'
// import  './froala/code_beautifier.min.js'
// import  './froala/code_view.min.js'
// import  './froala/colors.min.js'
// import  './froala/draggable.min.js'
// import  './froala/emoticons.min.js'
// import  './froala/font_size.min.js'
// import  './froala/font_family.min.js'
// import  './froala/image.min.js'
// import  './froala/file.min.js'
// import  './froala/image_manager.min.js'
// import  './froala/line_breaker.min.js'
// import  './froala/link.min.js'
// import  './froala/lists.min.js'
// import  './froala/paragraph_format.min.js'
// import  './froala/paragraph_style.min.js'
// import  './froala/video.min.js'
// import  './froala/table.min.js'
// import  './froala/url.min.js'
// import  './froala/entities.min.js'
// import  './froala/char_counter.min.js'
// import  './froala/inline_style.min.js'
// import  './froala/save.min.js'
// import  './froala/fullscreen.min.js'
// import  './froala/quote.min.js'
// import  './froala/cleave.min.js'
